...
- Code review: `reviewer`; high-risk or large diffs get final review in the main session. Security-sensitive review/analysis never dispatches or escalates onto fable (its safety classifiers can decline the request) - cap at `model=opus`.
