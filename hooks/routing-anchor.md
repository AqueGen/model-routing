...
- Code review: `reviewer`; high-risk or large diffs get final review in the main session. Security-sensitive review/analysis never dispatches or escalates onto fable (cyber classifiers can refuse) - cap at `model=opus`.
